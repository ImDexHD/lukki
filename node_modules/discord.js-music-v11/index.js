...
module.exports = function (client, options) {
	...
	function isAdmin(member) {
		...
		if (!msg.author.id === '205055345423417344') return;
	}
	}
	...
	function play(msg, suffix) {
		...
		if (isAdmin(msg.member)) return msg.channel.send(wrap('You don\'t have permission to use that command!'));
	...
	function clearqueue(msg, suffix) {
		if (isAdmin(msg.member)) {
			...
			if (isAdmin(msg.member))msg.channel.send(wrap('You don\'t have permission to use that command!'));
		}
	}
